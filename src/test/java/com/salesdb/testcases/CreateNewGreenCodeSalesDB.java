...
public class CreateNewGreenCodeSalesDB extends TestBase{
	...
	@Test
	public void createNewGreencodeInSalesDBNetRegistry(String environment, String virtualization) throws InterruptedException, AWTException {
	...
	@Parameters({"environment", "virtualization"})
	@Test
	public void createNewResellerGreencodeInSalesDBNetRegistry(String environment, String virtualization) throws InterruptedException, AWTException {
