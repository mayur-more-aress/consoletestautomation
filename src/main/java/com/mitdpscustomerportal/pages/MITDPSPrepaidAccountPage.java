...
public class MITDPSPrepaidAccountPage extends TestBase {

	public MITDPSPrepaidAccountPage() {
	...
	public void clickRechargeUsingCreditCard() throws InterruptedException {
		Thread.sleep(3000);
		WebElement element = driver.findElement(By.xpath("//*[@id='recharge-cc']"));
	...
	public void setNewCreditCardDetails(String cardowner, String cardnumber, String cardexpirymonth,
			String cardexpiryyear, String cardsecuritycode) throws InterruptedException {

		driver.findElement(By.xpath("//*[@id='add-prepaid']/div[1]/form/div[3]/div[1]/div/input")).sendKeys(cardowner);
		Thread.sleep(3000);
		driver.findElement(By.xpath("//*[@id='add-prepaid']/div[1]/form/div[3]/div[3]/div/input")).sendKeys(cardnumber);
		
		driver.findElement(By.xpath("//*[@id='selectExpMonth']")).sendKeys(cardexpirymonth);
		driver.findElement(By.xpath("//*[@id='selectExpYear']")).sendKeys(cardexpiryyear);
		driver.findElement(By.xpath("//*[@id='inputCode']")).sendKeys(cardsecuritycode);
