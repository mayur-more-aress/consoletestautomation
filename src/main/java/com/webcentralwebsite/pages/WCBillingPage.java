...
public class WCBillingPage extends TestBase {
	...
	public WCOrderCompletePage clickContinueButton() {
		...
		return new WCOrderCompletePage();
	}
	...
	public WCOrderCompletePage clickPlaceYourOrder() {
	...
	public WCPrepaidAccountPage clickEditPrepaidAccountLink() throws InterruptedException {

		driver.findElement(By.xpath("//*[@id=\"sidebar\"]/div[2]/div[1]/h3/span/a")).click();
		return new WCPrepaidAccountPage();
	}
}
