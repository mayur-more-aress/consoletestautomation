...
public class WCPrepaidAccountPage extends TestBase {

	public WCPrepaidAccountPage() {
	...
	public void setNewCreditCardDetailsQuest(String cardowner, String cardType, String cardnumber, String cardexpirymonth,
		...
		driver.findElement(By.xpath(
				...
				.click();
		Thread.sleep(1000);
		driver.findElement(By.name("creditCard.type")).sendKeys(cardType);
