...
public class WCAccountContactPage extends TestBase{
   ...
   public WCRegistrantContactPage clickContinueButton(){
    	...
    	return new WCRegistrantContactPage();
    }
   
   public WCRegistrantContactPage clickLoginButton(){
