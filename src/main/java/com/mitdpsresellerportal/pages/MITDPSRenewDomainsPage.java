...
public class MITDPSRenewDomainsPage extends TestBase {
	...
	public MITDPSRenewDomainsCartPage clickOnAddDomainsToList(){
		addDomainsToCart.click();
		return new MITDPSRenewDomainsCartPage();
	}
}
