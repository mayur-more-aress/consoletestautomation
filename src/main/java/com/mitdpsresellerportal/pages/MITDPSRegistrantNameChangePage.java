...
public class MITDPSRegistrantNameChangePage extends TestBase {
	...
	public MITDPSRegistrantNameChangePage() {
...
public String getAccountReferenceID() throws InterruptedException{
	Thread.sleep(10000);
	String accountReferenceElement = driver.findElement(By.xpath("//*[@id='order-complete']/table/tbody/tr[2]/td[1]")).getText();
	/*if (accountReferenceElement.isDisplayed()) {
		accountReference = accountReferenceElement.getText().substring(27);
	}*/
	return accountReferenceElement;
}
}
