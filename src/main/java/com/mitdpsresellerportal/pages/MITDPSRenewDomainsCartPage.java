...
public class MITDPSRenewDomainsCartPage extends TestBase {
	...
	public MITDPSRenewDomainsCartPage() {
	...
	public MITDPSRenewDomainsOrderCompletePage clickOnRenewDomain(){
		clickOnRenewDomain.click();
		return new MITDPSRenewDomainsOrderCompletePage();
	}
}
