...
public class MITOrderSSLPage extends TestBase
{
    ...
    {
    	int index =1;
        List<WebElement> lstProduct = driver.findElements(By.xpath("/html/body/div/div[3]/div[1]/div/div[3]/div/div/div/form/div/h3/span[1]"));
        for (WebElement product : lstProduct)
        {
            ...
            if(product.getText().equalsIgnoreCase(strSSLProduct))
            {
                ...
                driver.findElement(By.xpath("/html/body/div/div[3]/div[1]/div/div[3]/div/div/div/form/div["+pos+"]/div[2]/div/input")).click();
                break;
            }
        }
        Thread.sleep(8000);
    ...
    public MITAccountContactPage clickproccedbtn() throws InterruptedException 
    {
