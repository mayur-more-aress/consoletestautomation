...
public class MITDomainTransferPage extends TestBase
{
	//Objects 
    ...
    public MITAddDomainToTransferPage clickTransferButton()
    {
    	transferButton.click();
    	return new MITAddDomainToTransferPage();
    }
}
