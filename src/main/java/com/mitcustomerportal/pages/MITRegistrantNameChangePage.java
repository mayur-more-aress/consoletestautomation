...
public class MITRegistrantNameChangePage extends TestBase
{
	//Objects
	...
	public MITRegistrantNameChangePage(){
    ...
    public void clickOnGoButton() throws InterruptedException {
    	...
    	if(buttonGo.isDisplayed()||buttonGo.isEnabled()) {
    		buttonGo.click();
    		Thread.sleep(5000);
    	}
		else {
    ...
    public MITRegistrantContactPage clickOnAddSelectedDomainToCartButton() throws InterruptedException {
    	System.out.println("clicking continue button");
